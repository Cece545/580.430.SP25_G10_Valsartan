...
dydt = zeros(9,1);    % use a column vector 
...
p.k_CL_1 = 2 / p.Vd/0.05*1.2; %Valsartan clearance rate coefficient, 1/h
...
p.k_a = 1.409; %absorption rate comstant of Valsartan, 1/h
p.k_CL_3 = 0;
